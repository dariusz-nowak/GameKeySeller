...
connection.execute("CREATE TABLE adverts (id integer primary key AUTOINCREMENT, advert_id integer, platform text, title text, price float, currency text, url text)")
