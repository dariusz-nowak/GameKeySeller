...
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '-3 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+1 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+3 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+4 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+4 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+7 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+10 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+10 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+12 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+22 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+23 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+23 days'))")
# cursor.execute("INSERT INTO sales VALUES(null, 'title', 100, 50, 'platform', strftime('%Y-%m-%d %H-%M-%S','now', '+26 days'))")
# connection.commit()
