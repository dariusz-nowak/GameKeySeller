...
class Apps:
    ...
    def get_app_details(self, app_id: int) -> dict:
        response = request("get", self.__app_details_url, params={"appids": app_id, "l": "polish"})
    ...
    def search_url(self, search, country="PL"):
        params = {"f": "games", "cc": country, "realm": 1, "l": "polish"}
