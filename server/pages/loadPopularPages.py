...
from backend.database.databaseActions import loadPlatforms, loadFilteredSales, loadFilteredPopularPages
...
def loadPopularPages(self):
    ...
    html = """
            <div class="popular-pages-raport big window">
                ...
                <form action="/load-popular-pages" onsubmit="" class="hide">
                    <div class="filters">
    """
